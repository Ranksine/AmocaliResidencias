...
Public Class frm_Reportes_Procesado_Dialog_Rango
    ...
    Private Sub btnSiguiente_Click(sender As Object, e As EventArgs) Handles btnSiguiente.Click
        ...
        Try
            ...
            comando = New MySqlCommand("ConsultaProcesadoRangoFechas", conex)
            ...
            frm_Reportes_Procesado_General.rvReportesProcesado.LocalReport.ReportPath = "C:\Users\Omy\Desktop\Tec\ENE-JUN_2023\Proyectos\Amocali\Reporte_Procesado_RangoFechas.rdlc"
        ...
        Catch ex As Exception
            MsgBox("Error en la generación del reporte de rango de fechas: " & ex.Message)
        End Try
